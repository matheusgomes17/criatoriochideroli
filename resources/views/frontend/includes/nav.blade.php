<header id="header" class="transparent-header full-header" data-sticky-class="not-dark">
    <div id="header-wrap">
        <div class="container clearfix">
            ...
            <div id="primary-menu">
                <ul>
                    <li class="{{ active_class(Active::checkRoute('frontend.index')) }}">
                      <a title="Início" href="{{ route('frontend.index') }}">Início</a>
                    </li>
                    <li class="{{ active_class(Active::checkRoute('frontend.contact.index')) }}">
                      <a title="Contato" href="{{ route('frontend.contact.index') }}">Contato</a>
                    </li>
                    <li class="{{ active_class(Active::checkRoute('frontend.about')) }}">
                      <a title="Sobre Nós" href="{{ route('frontend.about') }}">Sobre Nós</a>
                    </li>
                    <li class="{{ active_class(Active::checkRoute('frontend.gallery')) }}">
                      <a title="Galeria" href="{{ route('frontend.gallery') }}">Galeria</a>
                    </li>
                </ul>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a title="{{ $subMenu->name }}" href="{{ route('frontend.category', $subMenu->id) }}">
                                {{ $subMenu->name }}</a></li>
                            @endforeach
                        </ul>
                    </li>
                ...
                <ul>
                    @if (! $logged_in_user)
                        <li class="{{ active_class(Active::checkRoute('frontend.auth.login')) }}">
                            <a title="{{ trans('navs.frontend.login') }}" href="{{ route('frontend.auth.login') }}">
                              {{ trans('navs.frontend.login') }}</a>
                        </li>

                        @if (config('access.users.registration'))
                            <li class="{{ active_class(Active::checkRoute('frontend.auth.register')) }}">
                                <a title="{{ trans('navs.frontend.register') }}" href="{{ route('frontend.auth.register') }}">
                                  {{ trans('navs.frontend.register') }}</a>
                            </li>
                        @endif
                    @else
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a title="{{ trans('navs.frontend.user.administration') }}" href="{{ route('admin.dashboard') }}">
                                      {{ trans('navs.frontend.user.administration') }}</a>
                                </li>
                                @endauth
                                <li class="{{ active_class(Active::checkRoute('frontend.user.account')) }}">
                                    <a title="{{ trans('navs.frontend.user.account') }}" href="{{ route('frontend.user.account') }}">
                                      {{ trans('navs.frontend.user.account') }}</a>
                                </li>
                                <li>
                                    <a title="{{ trans('navs.general.logout') }}" href="{{ route('frontend.auth.logout') }}">
                            ...
                            @forelse(getCartSession()->all() as $k => $item)
                                <div class="top-cart-item clearfix">
                                    <div class="top-cart-item-image">
                                        <a title="{{ $item['name'] }}" href="{{ route('frontend.product', $k) }}">
