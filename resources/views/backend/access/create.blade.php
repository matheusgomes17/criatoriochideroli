        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-2">
                        {{ Form::text('ddd', null, ['class' => 'form-control', 'maxlength' => '2', 'required' => 'required', 'data-mask' => '00', 'placeholder' => trans('validation.attributes.backend.access.users.ddd')]) }}
                    </div><!--col-lg-10-->
                    <div class="col-lg-8">
                        {{ Form::text('phone', null, ['class' => 'form-control', 'maxlength' => '9', 'required' => 'required', 'data-mask' => '000000000', 'placeholder' => trans('validation.attributes.backend.access.users.phone')]) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
...
@section('after-scripts')
    <script src="{{ asset('js/backend/jquery.mask.min.js') }}"></script>
