...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.backend.system.contacts.pending') }}</small>
    </h1>
@endsection
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-bcontact">
            <h3 class="box-title">{{ trans('labels.backend.system.contacts.pending') }}</h3>
        ...
        <div class="box-body">
            <div class="table-responsive">
                <table class="table table-condensed table-hover">
                    ...
                    @else
                        <tbody><tr><td>Não existem mensagens cadastradas.</td></tr></tbody>
                    @endif
                </table>
