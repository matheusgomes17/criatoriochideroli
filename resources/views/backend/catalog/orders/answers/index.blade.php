...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.backend.catalog.orders.answered') }}</small>
    </h1>
@endsection
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.catalog.orders.answered') }}</h3>
        ...
        <div class="box-body">
            <div class="table-responsive">
                <table class="table table-condensed table-hover">
                    ...
                    @else
                        <tbody><tr><td>Nenhum orçamento foi respondido.</td></tr></tbody>
                    @endif
                </table>
    ...
    <div class="box box-info">
        ...
        <div class="box-body">
            {!! history()->renderType('OrderAnswer') !!}
        </div><!-- /.box-body -->
    </div><!--box box-success-->
@endsection
